...
********PHONE INSTALLATION********
1. Download InverseAI.apk
2. Run on Android Device

********WINDOWS INSTALLATION********
1. Place InverseAI folder in \AndroidStudioProjects
2. Run the APP through emulator

********HOW TO USE INVERSE AI APP*******
1. Open the app and register a new user or login
...
7. Upload a file with the name "testdata.txt" and run the ANN Testing
8. Once satisfied with results press run to either retrain or move on to inverse
9. Enter the Inverse AI parameters
    # of Outputs, Optimize Outputs, # of Inputs, Input Bounds, # of runs
